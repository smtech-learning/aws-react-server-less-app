                ...
                <div className="register-container">
                    ...
                    <input id="_suburb" type="text" style={{ display: 'none' }} disabled />
                        ...
                        <input type="text" autocomplete="off_randomstring"
                            className="login-style" name="username" placeholder="Enter e-mail address" onChange={this.handlechnage} />
                        
                        <input type="text" autocomplete="off_randomstring"
                            className="login-style" name="email" placeholder="Renter the e-mail address" onChange={this.handlechnage} />
                        
                        <input type="password" autocomplete="new-password"
                            className="login-style" name="password" placeholder="Enter Password" onChange={this.handlechnage} />
                        
                        <input type="text" autocomplete="off_randomstring"
                            className="login-style" name="phone_number" placeholder="Enter Phone Number (Format should be: +1XXXXXXXXXX)" onChange={this.handlechnage} />
                        <br/>
